...
final_release_notes <- paste0(
  ...
  "## ✨ 主要功能\n\n",
  "### 包管理功能（增强版）\n",
  "- `ensure_packages()`: 自动安装缺失的包（支持CRAN、Bioconductor，自动尝试）\n",
  "- `install_from_multiple_sources()`: 多源包混合安装（CRAN、Bioconductor）\n",
  ...
  "- 支持多种样式选项和自定义设置\n\n",
  "### 开发工具功能\n",
  "- `create_dev_standards()`: 创建开发标准文档\n",
  "- `create_gitignore()`: 创建Git忽略文件\n",
"- `create_rbuildignore()`: 创建R构建忽略文件\n\n",
  "## 🔄 多源包安装功能\n\n",
  "### 支持的包源\n",
